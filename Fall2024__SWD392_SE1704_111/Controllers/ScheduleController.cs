...
namespace Fall2024__SWD392_SE1704_111.Controllers
{
    ...
    public class ScheduleController : ControllerBase
    {
        ...
        [Authorize(Roles = "Manager")]
        [HttpGet("PagingScheduleList_1")]
        public async Task<IActionResult> GetVoucherPaging_1([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 5)
        {
            // Gọi service để lấy danh sách người dùng
            var response = await _scheduleService.GetAllSchedulePagingAsync_1(pageNumber, pageSize);
